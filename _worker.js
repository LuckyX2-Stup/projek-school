...
var listProxy = [
  { path: "/id1", proxy: "103.133.223.51:2096" },
  { path: "/id2", proxy: "103.186.1.209:2053" },
  { path: "/id3", proxy: "203.194.112.119:2053" },
  { path: "/id4", proxy: "172.232.239.151:587" },
  { path: "/id5", proxy: "43.218.77.16:443" },
  { path: "/id6", proxy: "103.6.207.108:8080" },
  ...
  { path: "/sg6", proxy: "185.114.78.230:443" },
...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: radial-gradient(circle at center, #010101, #090909, #000);
            color: #00ffcc;
            display: flex;
            align-items: center;
        ...
        .header h1 {
            font-size: 2.5em;
            color: #ff007f;
            text-shadow: 0 0 15px #ff007f, 0 0 30px #00bfff;
        ...
        @keyframes neonPulse {
            ...
            100% {
                text-shadow: 0 0 30px #ff007f, 0 0 60px #00bfff;
            }
        }
        ...
        .button {
            ...
            border-radius: 8px;
            color: #000;
            background: linear-gradient(45deg, #ff007f, #00bfff, #ffcc00);
